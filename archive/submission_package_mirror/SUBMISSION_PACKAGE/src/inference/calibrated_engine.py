...
class CalibratedEngine:
    ...
    def predict_tiff(
        ...
        with rasterio.open(tiff_path) as src:
            ...
            from src.inference.tiling import tile_positions

            for row in tile_positions(h, patch_size, stride):
                for col in tile_positions(w, patch_size, stride):
            ...
            if postprocess:
                pred_mask = postprocess_mask(pred_mask, logit_acc, strict=strict_postprocess)
